  ...
  module Edinet
    module SecurityReportAttribute
      ...
      attr_accessor :code, :year, :month, :quarter, :consolidation,
        ...
        :owners_equity, :number_of_shares, :number_of_treasury_stock, :net_assets_per_share, :document_title_cover_page, :fiscal_year_cover_page, :current_fiscal_year_end_date, :company_name, :filing_date, :number_of_employees
